...
class SumoEnvironment:
    def __init__(self, sumo_cfg_path, tls_id, edges, lanes,
                 reward_function='queue_length', max_steps=6000):
    ...
    def reset(self, episode_idx=0):
        ...
        # Modified SUMO command: add "--step-length", "5" for faster simulation.
        sumoCmd = [
            "sumo",
...
def train_dqn_fixed_steps(sumo_cfg_path, tls_id, edges, lanes, n_episodes, max_steps):
    ...
    workbook  = xlsxwriter.Workbook('V1_SimpleR_Static_20_02.xlsx')
