...
### Upload the Code to Colab
    1. Create a new notebook.
    2. Insert the code to the section where "Start coding or generate with AI" is written.

### Upload the SUMO files

    Run this script and choose all the files associated specific road in SUMO:

    from google.colab import files
    uploaded = files.upload()

### Download necessary libraries
If you try to run the code without downloading the necessary libraries, you will face errors and will not be able to run the code. So, you need to download libraries.

#### Install SUMO in Colab
    !apt-get update
