...
def adjust_traffic_lights(tls_id, action):
    ...
    # Modify durations based on action
    if action[0] == "increase_green":
        phases[0].duration += 2  # Increase green phase by 2 seconds
    elif action[0] == "decrease_green":
        phases[0].duration -= 2  # Decrease green phase by 2 seconds
    elif action[0] == "increase_red":
        phases[1].duration += 2  # Increase red phase by 2 seconds
    elif action[0] == "decrease_red":
        phases[1].duration -= 2  # Decrease red phase by 2 seconds
